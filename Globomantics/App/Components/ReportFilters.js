...
function ReportFilters(props) {
    ...
    var handleFilterValueChange = function (name) { return function (event) {
        var _a;
        setFilterValues(__assign({}, filterValues, (_a = {}, _a[name] = event.target.value, _a)));
    }; };
    var handleFilterDateValueChange = function (name) { return function (value) {
        ...
        if (value != null) {
            ...
            setFilterValues(__assign({}, filterValues, (_a = {}, _a[name] = value.$d, _a)));
        }
        else {
            setFilterValues(__assign({}, filterValues, (_b = {}, _b[name] = null, _b)));
        }
    }; };
    // Order Id Filter
    var orderFilter;
